...
<section class="banner-carousel">
    ...
    <div class="container">
      ...
      <div class="row">
        <div class="col-sm-6 col-lg-4">
          <img src="./img/1.jpg" alt="" class="img__shop-offers border">
          <button class="main-btn shop-offers-btn">Buy it</button>
        </div>
        <div class="col-sm-6 col-lg-4">
          <img src="./img/1.jpg" alt="" class="img__shop-offers border">
          <button class="main-btn shop-offers-btn">Buy it</button>
          ...
          <form>
            <div class="form-row align-items-center">
              <div class="col-sm-5 my-1">
                <h4><img src="./img/mail.svg" alt="" class=""> Sign up for our latest offers</h4>
              </div>
              <div class="col-sm-5 my-1">
  ...
  <hr>
  <section class="banner2 pt-3 display-sm-none">
    <div class="container">
      <div class="row">
        <div class="col-lg-12">
  ...
  <section class="product-example">
    <div class="container">
      <div class="row product">
        <div class="col-lg-12">
          <h3 class="shop-title  text-center">Our products</h3>
        </div>
