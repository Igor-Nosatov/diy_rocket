...
<section class="footer__brand p-4">
    <div class="container">
        <div class="row">
            <div class="col">
                <img src="{{url('./image/brand1.jpg')}}" alt="" class="footer-brand ">
            </div>
            <div class="col">
                <img src="{{url('./image/brand2.jpg')}}" alt="" class="footer-brand ">
            </div>
            <div class="col">
                <img src="{{url('./image/brand3.jpg')}}" alt="" class="footer-brand ">
            </div>
            <div class="col">
                <img src="{{url('./image/brand4.jpg')}}" alt="" class="footer-brand ">
            </div>
            <div class="col">
                <img src="{{url('./image/brand5.jpg')}}" alt="" class="footer-brand ">
            </div>
        </div>
    </div>
</section>
        ...
        <div class="row">
            ...
            <div class="col-sm-12 col-lg-4">
                ...
                <div class="payments d-flex flex-row justify-content-center">
                    <img src="{{url('./image/p1.webp')}}" alt="" class="img-fluid">
                    <img src="{{url('./image/p2.webp')}}" alt="" class="img-fluid">
                    <img src="{{url('./image/p3.webp')}}" alt="" class="img-fluid">
                    <img src="{{url('./image/p4.webp')}}" alt="" class="img-fluid">
                    <img src="{{url('./image/p5.webp')}}" alt="" class="img-fluid">
                </div>
            </div>
            <div class="col-sm-12 col-lg-4">
    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-sm-6 col-lg-6">
                ...
                <ul class="nav justify-content-center">
                    <li class="nav-item">
                        <img src="{{url('./image/app-apple-prompt.webp')}}" alt="">
                    </li>
                    <li class="nav-item">
                        <img src="{{url('./image/app-google-prompt.webp')}}" alt="">
                    </li>
                </ul>
            </div>
        </div>
